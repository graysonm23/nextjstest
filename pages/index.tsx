...
const Home: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>Black Freelancer</title>
    <meta name="title" content="Black Freelancer" />
    ...
    <meta property="og:title" content="Black Freelancer"/>
    ...
    <meta property="twitter:title" content="Black Freelancer"/>
